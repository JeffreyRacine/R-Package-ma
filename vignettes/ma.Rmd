...
plot(model,plot.data=TRUE)
```
\caption{\label{indiamean}India childhood nutrition derivative estimate.}
\end{figure}
...
```
\caption{\label{indiaderiv}India childhood nutrition derivative estimate.}
\end{figure}
