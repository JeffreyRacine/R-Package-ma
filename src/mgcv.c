...
*/
void taylor_model_mm(double *x, int *z, double *t, int *d, int *m, int *n, int *zn)
{
...
void taylor_model_tmm(SEXP X,SEXP Z, SEXP T, SEXP D,SEXP M, SEXP N, SEXP ZN)
{
		/* wrapper for calling taylor_tmodel_mm using .Call */
		double *x,*t;
		int *d,*m,*n, *zn, *z;
		...
		taylor_model_mm(x, z, t, d, m, n, zn);
